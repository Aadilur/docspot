      ...
      <div className="mx-auto flex w-full max-w-5xl items-center justify-between gap-4 px-5 py-4">
        ...
        <div className="flex items-center gap-3">
          <details className="relative group sm:hidden">
            <summary
              className="cursor-pointer list-none select-none rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-200 dark:focus:ring-brand-900 [&::-webkit-details-marker]:hidden"
              aria-label="Menu"
            >
              <span className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-zinc-200 bg-white text-zinc-700 shadow-sm hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-200 dark:hover:bg-zinc-900">
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    [
                      ...
                      isActive
                        ? "border-brand-200 bg-brand-50 text-brand-900 dark:border-brand-900/50 dark:bg-brand-950/30 dark:text-brand-200"

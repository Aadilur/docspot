...
import {
  addObjectAttachment,
  createObjectGroupWithFirstReport,
  listObjectGroups,
...
export default function OtherDocPage() {
  ...
  async function onCreate() {
    ...
    try {
      ...
      const created = await createObjectGroupWithFirstReport({
        report: {
          title: trimmed,
  ...
  const onPickedFiles = async (e: ChangeEvent<HTMLInputElement>) => {
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="min-w-0">
                      <div className="truncate text-sm font-semibold text-zinc-900 dark:text-zinc-50">
                        {g.title || g.latestReport?.title || t("objectGroup")}
                      </div>
              ...
              <div className="grid gap-3">
                <label className="grid gap-1">
                  ...
                  <input
                    ...
                    placeholder={t("objectTitlePlaceholder")}
                  />
                </label>
